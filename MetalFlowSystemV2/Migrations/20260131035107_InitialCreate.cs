        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrossesMidnight = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapacityLbs = table.Column<decimal>(type: "decimal(12, 2)", precision: 12, scale: 2, nullable: false),
                    Plate = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    AssignedDriverUserId = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionAreas_BranchId_Code",
                table: "ProductionAreas",
                columns: new[] { "BranchId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Shifts_BranchId_Code",
                table: "Shifts",
                columns: new[] { "BranchId", "Code" },
                unique: true);
